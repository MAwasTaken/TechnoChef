...
const AllProducts = () => {
	return (
		<div className="flex flex-col gap-y-5 p-5 justify-center items-center w-full">
			<label htmlFor="" className="flex flex-row w-full gap-x-2 text-3xl">
				<BiShoppingBag className="text-red-500"></BiShoppingBag>
				<span>محصولات</span>
			</label>
			{/* new profuct */}
			<div className="flex flex-row w-full h-max">
				<button className="flex flex-row items-center gap-x-2 text-base text-blue-700 py-1">
					<BiPlus></BiPlus>
