	...
	return (
		<section className="container pt-8 md:pt-12">
			...
			<div className="flex items-start justify-between gap-x-10 md:gap-x-40">
				...
				>
					شرکت بازرگانی لوازم خانگی پارسیان سرو نیوساد با برند تکنوشف بیش از یک دهه تجربه یکی از
					شرکت های پیشگام در زمینه توزیع و فروش لوازم خانگی می باشد . این شرکت کوشش دارد با افتخار
					نیازهای خانواده هارا در زمینه امور خانگی برآورده نماید. هدف ما اراءه محصولات با کیفیت با
					برند معتبر تکنو در پی توسعه فرهنگ مصرف پایدار خانواده است : تا یک همراه قابل اعتماد در
					امور خانه ها باشیم و بتوانیم بهترین خدمات را به مشتریان عزیزمان اراءه دهیم . متخصصان ما با
					برسی دقیق نیازهای بازار همواره در همه ی مراحل انتخاب خرید و فروش بهترین و برترین محصولات
					را به شما هموطنان عزیز اراءه میدهند . ما با بهره گیری از تجربه روزافزون و دانش فنی متخصصان
					به طور پیوسته در حال بهبود روش های خدمات رسانی و افزایش کیفیت محصولات خود هستیم . از جمله
					خدماتی که ما در اختیار مشتریان عزیزمان قرار میدهیم می توان به مشاوره فنی خدمات پس از فروش
					و تحویل سریع محصولات اشاره کرد . ما هم چنین اهمیت بالایی به نظرات و انتقادات مشتریانمان
					میدهیم و کوشش داریم تا با به کارگیری آن ها بهترین راه کار هارا در امور لوازم خانگی منزل
					شما پیشنهاد دهیم .
				</p>
