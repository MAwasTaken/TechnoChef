...
export const ProductDetailsBox = () => {
    return (
        <div className='flex flex-row gap-x-2 items-center p-5 justify-center w-[1200px] h-[400px] rounded-3xl bg-gray-600	'>
            {/* right side */}
            <div className="flex w-2/6 justify-center items-center h-full">
            ...
            <div className="flex p-5 flex-col w-full h-full">
                ...
                <div className="flex flex-col gap-y-1 px-6 items-end justify-end h-1/2">
                    ...
                    <a href="/" className='flex items-center flex-row justify-center bg-yellow-500 gap-x-3 rounded-2xl px-4 py-3 hover:bg-yellow-600 font-Lalezar text-lg'><span>خرید محصول</span><BiShoppingBag className='text-red-500 text-xl'></BiShoppingBag></a>
                </div>
            </div>
