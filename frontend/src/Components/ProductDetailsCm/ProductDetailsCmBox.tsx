    ...
    return (
            <div className="flex flex-col gap-y-7 p-5 w-full h-max">
                ...
                <div className="flex flex-col gap-y-4 w-3/5 bg-gray-200 h-max rounded-2xl p-5">
                    ...
                    <p className='leading-6'>Lorem, ipsum dolor sit amet consectetur adipisicing elit Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae id dolore qui voluptatibus ducimus fugiat repellat eligendi laudantium, iusto ullam rem dignissimos optio ad animi quas! Soluta, quis deleniti. Animi.. Officia necessitatibus ea neque non et quo accusantium, molestias dolorum eum repudiandae odio perspiciatis dolores, error consectetur qui debitis eos illum distinctio?</p>
                </div>
