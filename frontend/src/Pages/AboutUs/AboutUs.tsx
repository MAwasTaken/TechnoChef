				...
				<main className="flex flex-col justify-center">
					...
					<section className="flex flex-row">
						...
						<div className="flex flex-col justify-center gap-y-7 text-center">
							...
							<p className="text-gray-800 leading-6 text-base">
								Lorem Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequuntur
								voluptates quaerat ipsa repudiandae, eius reprehenderit, adipisci porro totam beatae
								possimus debitis explicabo saepe! Dolores odio eveniet placeat quia facere
								optio.loipsum dolor, sit amet consectetur adipisicing elit. Sint in modi ipsam
								voluptatibus eius minima amet ipsa sequi. Natus repellat saepe error asperiores illo
								id ducimus dolor aut rerum voluptatem?Lorem ipsum dolor sit amet consectetur,
								adipisicing elit. Quibusdam explicabo aliquam ad porro placeat reprehenderit, dolor
								odio temporibus reiciendis dolores, odit voluptatibus eveniet repudiandae sequi enim
								neque necessitatibus vero cumque.
							</p>
						</div>
					</section>
				</main>
